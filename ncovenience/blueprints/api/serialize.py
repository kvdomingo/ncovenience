...
from ncovenience.blueprints.api.data import (
...
def get_metro_cases():
    ...
    metro_city_cases = ph_cases.query("`status` == ''").residence
    metro_city_cases = (
        metro_city_cases[metro_city_cases.str.contains("Metro Manila")]
        .str.split(", ")
        .str[0]
        .value_counts()
        .drop("Metro Manila")
    ...
    metro_city_recov = ph_cases.query("`status` == 'Recovered'").residence
    metro_city_recov = (
        metro_city_recov[metro_city_recov.str.contains("Metro Manila")]
        .str.split(", ")
        .str[0]
        .value_counts()
        .drop("Metro Manila")
    ...
    metro_city_death = ph_cases.query("`status` == 'Died'").residence
    metro_city_death = (
        metro_city_death[metro_city_death.str.contains("Metro Manila")]
        .str.split(", ")
        .str[0]
        .value_counts()
        .drop("Metro Manila")
